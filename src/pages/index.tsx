  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental - Your One-Stop Solution for Renting Construction Tools from a Central Supplier with Multiple Outlets."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to Construction Tool Rental - Your One-Stop Solution for Renting Construction Tools from a Central Supplier with Multiple Outlets.`}
            </Text>
